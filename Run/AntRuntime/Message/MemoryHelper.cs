...
namespace AntRuntime
{
    ...
    public static class MemoryHelper
    {
        ...
        public static unsafe void WriteBytes(void* ptr,int offset, byte[] values, int len)
        {
            try
            {
                System.Runtime.InteropServices.Marshal.Copy(values, 0, (IntPtr)(ptr)+offset, len);
            }
        ...
        public static unsafe void WriteString(void* ptr, int offset, string value, int Maxlen)
        {
            try
            {
        ...
        /// <param name="ofs"></param>
        /// <returns></returns>
        public static unsafe long ReadInt64(IntPtr ptr, long ofs)
        {
            return ReadInt64((void*)ptr, ofs);
        }
        ...
        /// <param name="ofs"></param>
        /// <returns></returns>
        public static unsafe ulong ReadUInt64(IntPtr ptr, long ofs)
        {
            return ReadUInt64((void*)ptr, ofs);
        }
